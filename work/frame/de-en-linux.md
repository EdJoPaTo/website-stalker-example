...
How we work with Linux distributions
----------
...
[Compatibility chart](https://frame.work/laptop13pro?tab=linux)

#### Framework Laptop 13 ####

[Install guide](https://guides.frame.work/c/Framework_Laptop#Section_Installation)

[Compatibility chart](https://frame.work/laptop13?tab=linux)

#### Framework Laptop 16 ####

[Install guide](https://guides.frame.work/c/Framework_Laptop_16#Section_Installation)

[Compatibility chart](https://frame.work/laptop16?tab=linux)

#### Framework Desktop ####

[Install guide](https://guides.frame.work/c/Framework_Desktop#Section_Installation)

[Compatibility chart](https://frame.work/desktop?tab=linux)
...
The Framework [Forum](https://community.frame.work/) is where Linux users share setup tips, troubleshoot issues, and help each other get the most out of their laptops Whether you’re installing your first distro or tweaking your system into perfection, you’ll find real answers from people running Framework products every day.

Knowledge Base
----------

The [Knowledge Base](https://knowledgebase.frame.work/?_gl=1*1g1s3lo*sg_ga4w_production_ga*MTUxODM4MTgzNS4xNzI0NDAzODU3*sg_ga4w_production_ga_PYG8X65YJJ*czE3Njk0MTUzNDIkbzg1NyRnMSR0MTc2OTQxNjc3NiRqNjAkbDAkaDA.)is your go-to source for answers to common questions and troubleshooting tips, our articles written to be easy to follow and quick to reference, if you need it.
...
[Read article](https://www.phoronix.com/review/framework-laptop-12)
...
[Read article](https://www.zdnet.com/article/not-enough-people-are-talking-about-this-windows-laptop-beast-that-i-assembled-in-just-minutes/)
...
[Watch video](https://www.youtube.com/watch?v=ziZDzrDI7AM)
...
[View guide](https://guides.frame.work/Wiki/Framework_Support_Linux_Expectations_Guide)
