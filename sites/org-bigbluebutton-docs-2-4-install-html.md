...
if you are upgrading BigBlueButton 2.2, we recommend setting up a new Ubuntu 18.04 server and [transfer over the 2.2 recordings to the 2.4 server](https://docs.bigbluebutton.org/admin/customize.html#transfer-published-recordings-from-another-server).
