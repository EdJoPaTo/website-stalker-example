...
To use your own background images copy them into the directory`/var/www/bigbluebutton/client/images/virtual-backgrounds`.
For each image copy a thumbnail of the image of 50x50 pixels size into`/var/www/bigbluebutton/client/images/virtual-backgrounds/thumbnails`.
