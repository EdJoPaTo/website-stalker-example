...
```
 name="from_my_provider">
  field="destination_number" expression="^EXTERNALDID">
    ...
    application="play_and_get_digits" data="5 5 3 7000 # conference/conf-pin.wav ivr/ivr-that_was_an_invalid_entry.wav pin \d+"/>
 ...
 name="conf_bad_pin">
  field="${pin}" expression="^\d{5}$">
    application="answer"/>
    application="sleep" data="1000"/>
    application="play_and_get_digits" data="5 5 3 7000 # conference/conf-bad-pin.wav ivr/ivr-that_was_an_invalid_entry.wav pin \d+"/>
    application="transfer" data="SEND_TO_CONFERENCE XML public"/>
