...
You first need to set up a BigBlueButton 2.3 server. See the instructions at
[Install BigBlueButton 2.3](https://docs.bigbluebutton.org/2.3/install.html)
.
...
Before you can start developing on BigBlueButton, you must install BigBlueButton 2.3 (see
[installation steps](https://docs.bigbluebutton.org/2.3/install.html)
...
BigBlueButton 2.3 source code lives on branch
v2.3.x-release
. This is where any patches to 2.3 will be merged. If you are looking to customize your BigBlueButton 2.3 clone to fit your needs, this is the branch to use.
...
git checkout
-b
my-changes-branch upstream/v2.3.x-release
...
If you want to test the installation or to easily start/join meetings while you are developing, you can install
bbb-demos
:
...
Before testing, make sure you have set
secure: false
in
/usr/share/bbb-web/WEB-INF/classes/application.yml
file:
...
The HTML5 client in BigBlueButton 2.3 depends on Meteor version 1.10.2. Navigate to
bigbluebutton-html5/
...
[bigbluebutton-html5/deploy_to_usr_share.sh](https://github.com/bigbluebutton/bigbluebutton/blob/v2.3.x-release/bigbluebutton-html5/deploy_to_usr_share.sh)
...
Follow
[Configure SSL on your BigBlueButton server](https://docs.bigbluebutton.org/2.3/install.html#configure-ssl-on-your-bigbluebutton-server)
...
Then setup your shared directory by editing
/etc/samba/smb.conf
...
comment
=
BigBlueButton Development share
path
=
/home/ubuntu
browseable
