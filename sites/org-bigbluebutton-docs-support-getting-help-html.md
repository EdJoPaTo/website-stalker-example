...
BigBlueButton is a very customizable system, see [customizable options](https://docs.bigbluebutton.org/admin/customize). If you don’t see an option to customize BigBlueButton to your needs and have some experience with software development, you can [setup a development environment](https://docs.bigbluebutton.org/2.3/dev.html) and modify BigBlueButton to your needs. If you end up designing new functionality, we encourage you to upstream the changes via a pull request so that others can seek benefit from it too.
