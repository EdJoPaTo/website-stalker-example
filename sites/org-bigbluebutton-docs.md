...
4. [Set up a development environment](https://docs.bigbluebutton.org/dev/setup.html) to modify and extend BigBlueButton itself.
...
The latest version of BigBlueButton is BigBlueButton 2.5. See [install BigBlueButton](https://docs.bigbluebutton.org/2.5/install.html).
