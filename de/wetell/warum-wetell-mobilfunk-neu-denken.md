...
* #### Warum ist Klimaschutz im Mobilfunk wichtig? ####

  Jedes Like, jede Telefonminute, jedes versandte Foto produzieren CO<sub>2</sub>. Und zwar insgesamt so viel wie der innerdeutsche Flugverkehr! Die Branche wächst rasant, der Bedarf an mobilen Daten wird immer größer – und damit auch die Menge an Emissionen.
...
* #### CO<sub>2</sub> vermeiden ####
  ...
  Die allerbeste Klimaschutzmaßnahme ist es immer, erst gar keine CO<sub>2</sub>-Emissionen entstehen zu lassen. Daher setzen wir in unserem Bürobetrieb auf klimafreundliche Produkte und Dienstleistungen. Das kannst du dir in etwa so vorstellen:

  Wir sitzen an refurbishten Computern, die mit Ökostrom laufen, neben uns die Tasse fair gehandelten Biokaffee und speichern die aktuellen Dateien auf dem mit Windenergie betriebenen Server ab. Die Kollegin bucht für die nächste Dienstreise ein Bahnticket mit der Kreditkarte der öko-sozialen Bank, bei der wir unser Geschäftskonto haben.

  Das Marketingteam bestellt bei der Umweltdruckerei neue Flyer, während im Meetingraum, den wir uns im Co-Working-Space mit anderen Unternehmen teilen, darüber beraten wird, wie wir den CO<sub>2</sub>-Fußabdruck unserer Webseite verkleinern können.

  Machen wir dabei alles schon perfekt? Keinesfalls. Aber wir folgen in unserem Alltag aufmerksam der Leitfrage „geht das auch nachhaltiger?“ und entwickeln uns stetig weiter.

* #### CO<sub>2</sub> mit Pflanzenkohle ausgleichen ####
  ...
  Daher kompensieren wir in Kooperation mit [Carbonfuture](https://www.carbonfuture.earth/) durch Pflanzenkohle. Die Kohle wird in Europa aus Forst-Reststoffen und anderen pflanzlichen Abfällen hergestellt. Sie sorgt dafür, dass das in den Pflanzen gespeicherte CO<sub>2</sub> nicht wieder in die Atmosphäre gelangt. Der Kohlenstoff wird – wie der Name es schon verrät – langfristig in der Kohle gebunden. Die Pflanzenkohle kann man super als Düngezusatz nutzen und damit die Bodenqualität und Biodiversität fördern. Eine absolute Win-win-Geschichte also!

* #### Energiewende vorantreiben ####

  Ganz klar: Langfristig ist Ausgleichen von Emissionen für uns keine Lösung. Ist doch viel besser, wenn erst gar keine entstehen! Allerhöchste Zeit also für die Energiewende. Damit es mit der schneller vorangeht, fördern wir zusätzlich den Ausbau erneuerbarer Energien.

  Dafür investieren wir in Solar- und Windkraftanlagen. Und damit sich Menschen aktiv an der Energiewende beteiligen können, verlosen wir immer wieder [Balkon-Solarkraftwerke in unserer Community](https://www.wetell.de/community/newsblog/sonnige-zeiten-auf-balkonien/). Zusätzlich fördern wir gute neue Ideen und investieren in klimawirksame Start-ups.
...
Egal ob bei Kund\*innen, Mitarbeitenden oder Kooperationspartner\*innen: Wir bringen allen Menschen dieselbe Fairness und Menschlichkeit entgegen, die wir uns selbst auch wünschen.

Unser Geheimrezept dafür: Ehrlichkeit, Transparenz, Vertrauen und vor allem: Profitinteressen hintenanstellen. Denn oft geht die eigene Gewinnoptimierung eben zulasten der anderen. Ob es dann der Kunde ist, der in den Knebelvertrag gelockt, oder die Lieferantin, die über den Tisch gezogen wird.

Wir aber streben nicht nach dem großen Geld, sondern einer gemeinwohlorientierten Wirtschaft. Ganz klar also: Fairness ist bei uns Programm!

* #### Faire Konditionen ####

  Bye bye Knebelvertrag, willkommen Freiheit: Alle WEtell Tarife sind monatlich kündbar. Bei uns gibt’s keine unseriösen Lockangebote, keine falschen Versprechungen. Schließlich wollen wir dich überzeugen und nicht überrumpeln. Bei uns kommst du voll auf deine Kosten – und dank [Preistransparenz](https://www.wetell.de/mobilfunk/#preistransparenz)auch dahinter.

  Wir legen uns voll ins Zeug, um Tarifverbesserungen automatisch an unsere Bestandskund\*innen weiterzugeben, statt sie – wie in der Branche üblich - nur für neue Vertragsabschlüsse vorzubehalten.

* #### FAIRstärker – unser Soli-Option ####

  Wir finden: Jede\*r soll sich gemeinwohlorientierte Alternativen leisten können – auch im Mobilfunk. Deswegen haben wir den [WEtell FAIRstärker](https://www.wetell.de/mobilfunk/optionen/fairstaerker) ins Leben gerufen.
...
* #### Deine Daten gehören dir ####
  ...
  Wir machen uns dafür stark, dass dieser Schatz nicht in die falschen Hände gerät, und nutzen deine Daten nur genau dafür, wofür du sie uns übergibst: für deinen Mobilfunk.

  Wir erheben nur so viele Daten wie nötig und löschen sie so früh wie möglich. Wir halten Personendaten und detaillierte Daten zum Mobilfunkverhalten getrennt: Der Mobilfunkbetreiber kennt deinen Namen nicht, wir kennen dein Surfverhalten nicht.
  ...
  * Stammdaten (Name, Adresse, Geburtsdatum, Bankdaten): Bis 10 Jahre nach Vertragsende (gesetzlich verpflichtend), starke Zugriffseinschränkung ab 3 Monate nach Vertragsende
  ...
  Alle Daten, die für die Rechnungserstellung relevant sind, speichern wir 3 Monate lang, um nachweisen zu können, wie die Rechnung zustande gekommen ist. Die Stammdaten müssen wir gesetzlich vorgeschrieben sehr lange speichern, damit sie für Steuerprüfungen o.ä. vorliegen.
...
Unser Service ist das Herzstück unseres Unternehmens. Schließlich verkörpert er tagtäglich unsere wichtigsten Werte: Wertschätzende Kommunikation und Dialog auf Augenhöhe.

Unser Serviceteam sitzt mit dem Rest des WEtell Teams gemeinsam im Büro, statt in einem anonymen Callcenter. Und anstelle von Leistungsvorgaben wie „100 bearbeitete Tickets pro Stunde“ ist ehrliche, persönliche Beratung das oberste Gebot.

Ob per [Telefon](tel:+4976176999848), [Mail](mailto:service@wetell.de) oder [Threema](https://threema.id/VCWEM8SX?text=) – wir sind für dich da und finden gemeinsam die beste Lösung.
