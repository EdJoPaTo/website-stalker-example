...
Note that this ambiguity does *not* exist for name collisions on [inherent implementations](../../reference/items/implementations.html#inherent-implementations), as they take priority over trait items.
