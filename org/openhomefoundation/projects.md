...
[### ESP Web Tools ### User friendly tools to manage ESP8266 and ESP32 devices in a web browser. LibraryESP32](https://esphome.github.io/esp-web-tools/)

[### Improv Wi-Fi ### Open standard for connecting devices to Wi-Fi using Bluetooth LE or Serial. Open standardWi-Fi](https://www.improv-wifi.com/)
...
[### Zigpy ### Hardware independent Zigbee integration that implements Zigbee as a Python library. DriverZigbee](https://github.com/zigpy/zigpy)

[### Matter.js ### Matter Controller Server implementation over WebSockets. DriverMatter](https://github.com/matter-js/matter.js)

[### Z-Wave JS ### An open source Z-Wave device driver. DriverZ-Wave](https://github.com/zwave-js/zwave-js)
...
[### Piper ### Local neural text-to-speech system that sounds great and is optimized for the Raspberry Pi 4. LibraryVoice](https://github.com/rhasspy/piper)
